...
Just chat naturally with the bot! It understands context and uses **55+ tools automatically**.
...
graph TD;
    ...
    Tools -->|27 Tools| Onchain[🪙 OnchainOS DeFi API];
...
### 🎮 指令参考
#### 🤖 AI 对话 (自然语言交互)
只需像和真人聊天一样与机器人对话，它能理解上下文并**自动调用 55+ 种区块链工具**。
...
graph TD;
    ...
    Tools -->|调用 27 种工具| Onchain[🪙 OnchainOS DeFi API];
...
graph TD;
    ...
    Tools -->|Tiếp Nhận 27 Tools| Onchain[🪙 API OKX OnchainOS];
